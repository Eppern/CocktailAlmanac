...
CREATE TABLE [dbo].[RECIPE_STEP] (
	...
	CONSTRAINT [FK_RECIPE_STEP_INGREDIENT] FOREIGN KEY ([IngredientId]) REFERENCES [INGREDIENT]([IngredientId]) ON DELETE CASCADE,
    CONSTRAINT [RECIPE_STEPId] PRIMARY KEY CLUSTERED ([RecipeId] ASC, [IngredientId] ASC)
)
