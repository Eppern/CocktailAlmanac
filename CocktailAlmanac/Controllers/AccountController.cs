...
namespace CocktailAlmanac.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var user = new ApplicationUser { UserName = model.UserName, Email = model.Email, DOB = model.DOB };
        ...
        public async Task<ActionResult> ExternalLoginConfirmation(ExternalLoginConfirmationViewModel model, string returnUrl)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var user = new ApplicationUser { UserName = model.UserName, Email = info.Email, DOB = model.DOB };
                if(info.Login.LoginProvider == "Google")
                {
                    user.FirstName = info.ExternalIdentity.Claims.FirstOrDefault(c => c.Type == ClaimTypes.GivenName).Value.ToString();
                    user.LastName = info.ExternalIdentity.Claims.FirstOrDefault(c => c.Type == ClaimTypes.Surname).Value.ToString();
                    user.UserLanguage = info.ExternalIdentity.Claims.FirstOrDefault(c => c.Type == "language").Value.ToString();
                    user.Gender = info.ExternalIdentity.Claims.FirstOrDefault(c => c.Type == "gender").Value.ToString() == "male";
                }
